<%@ Page Title="StrategicPlanDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="HPPortal.Web.StrategicPlans.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this StrategicPlan?</h3>
        <asp:FormView runat="server"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Delete StrategicPlan</legend>
							<div class="row">
