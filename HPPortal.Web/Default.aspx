...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="form-horizontal">
            ...
            <div class="col-md-4">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">Task Alert
                        </h3>
                    </div>
                    <div class="panel-body" style="height: 210px">
                        <ul id="scroller2">

                            <asp:ListView ID="listViewTasks" runat="server"
                                ...
                                <ItemTemplate>
                                    <li style="list-style: none;">
                                         ...
                                         <label style="width: 90px; color: #428bca; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Task Module</label>:  &nbsp; <a href='<%# Item.Url %>'> <%#: Item.TaskModule %> </a>
                                        <br />
                                        <label style="width: 90px; color: #428bca; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Partner</label>:  &nbsp; <%#: Item.PartnerName %>
                                        <br />
                                        <label style="width: 90px; color: #428bca; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Quarter</label>:  &nbsp; <%#: Item.Quarter %>
